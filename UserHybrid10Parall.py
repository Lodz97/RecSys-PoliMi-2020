...
if __name__ == '__main__':
    ...
    #hyb3y.fit(alpha=0.5)
    # Kaggle MAP 0.9516
    hyb3 = ScoresHybridSpecializedFusion.ScoresHybridSpecializedFusion(URM_ICM_train, hyb2, hyb3x, 2.1)
    #hyb3 = RankingHybrid.RankingHybrid(URM_ICM_train, hyb7, hyb3x)
    #hyb2 = ScoresHybridKNNCFKNNCBF.ScoresHybridKNNCFKNNCBF(URM_train, ICM_all)
