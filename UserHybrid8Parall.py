...
if __name__ == '__main__':
    ...
    hyb3x.fit(alpha=0.5)
    '''hyb3z = ScoresHybridSpecializedAdaptive.ScoresHybridSpecializedAdaptive(URM_ICM_train, URM_ICM_train.T)
    hyb3z.fit(**{"topK_P_C": 431, "alpha_P_C": 0.5482943434345057, "normalize_similarity_P_C": False, "topK_C": 62,
                "shrink_C": 1066, "similarity_C": "tversky", "normalize_C": True, "feature_weighting_C": "none",
                "topK_P": 743, "alpha_P": 1.1119995780792453, "normalize_similarity_P": False, "topK": 1104,
                "shrink": 1376, "similarity": "cosine", "normalize": False, "feature_weighting": "none", "threshold": 27})'''
    hyb3z = ScoresHybridKNNCFKNNCBF.ScoresHybridKNNCFKNNCBF(URM_ICM_train, URM_ICM_train.T)
    hyb3z.fit(**{"topK_CF": 488, "shrink_CF": 1500, "similarity_CF": "tversky", "normalize_CF": True, "topK": 1500,
    ...
    hyb3 = ScoresHybridSpecializedFusion.ScoresHybridSpecializedFusion(URM_ICM_train, hyb2, hyb3x, 5.9)
    hyb3y = ScoresHybridSpecializedFusion.ScoresHybridSpecializedFusion(URM_ICM_train, hyb2, hyb3x, 5.9)
    hyb7 = ScoresHybridSpecializedFusion.ScoresHybridSpecializedFusion(URM_ICM_train, hyb3y, hyb3z, 6.1)
    #hyb7 = ItemKNNScoresHybridRecommender.ItemKNNScoresHybridRecommender(URM_train, hyb3y, hyb3z)
    #hyb7 = ItemKNNScoresHybridRecommender.ItemKNNScoresHybridRecommender(URM_train, hyb3x, hyb3)
    #hyb7.fit(alpha=0.5)
    ...
    CreateCSV.create_csv(target_ids, item_list, 'Hyb_URM_ICM_cold_warm_V2_more_mix')
